...
{
    public partial class BookingCancellation : Form
    {
        ...
        string o;
        private void BookingCancellation_Load(System.Object sender, System.EventArgs e)
        {
        ...
        private void SNo_Click(System.Object sender, System.EventArgs e)
        {
            clearall();
            try
            {
                if (string.IsNullOrEmpty(SeatNo1.Text.Trim()))
                {
                    MessageBox.Show("Plz.. Enter Correct Seat No");
                }
                else if (string.IsNullOrEmpty(ST1.Text.Trim()) & ST1.Text == "Select")
                {
                    MessageBox.Show("Plz.. Enter Correct SeatType");
                }
                else
                {
                    con = new SqlConnection("Data Source=.\\SQLEXPRESS;Initial Catalog=Bus_System;Integrated Security=True");
