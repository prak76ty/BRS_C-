...
namespace Bus_Reservation
{
    ...
    public partial class SeatSelectionLower22 : Form
    {
        ...
        public string RN;
        public string BN0;
        public SeatSelectionLower22(System.Object msgreceived, System.Object BN, System.Object R, System.Object B)
            : base()
        {
            Load += SeatSelectionLower22_Load;
            InitializeComponent();
        ...
        private void Button22_Click(System.Object sender, System.EventArgs e)
        {
            if (checkm == "NA")
            {
                SeatSelectionUpper22 SSU0 = new SeatSelectionUpper22("NA", BookingNo.Text, RNO.Text, BNO.Text);
                this.Close();
                SSU0.BringToFront();
                SSU0.Show();
            }
            ...
            {
                SeatSelectionUpper22 SSU1 = new SeatSelectionUpper22("AB_UN", BookingNo.Text, RNO.Text, BNO.Text);
                this.Close();
                SSU1.BringToFront();
                SSU1.Show();
            }
        }
        private void SeatSelectionLower22_Load(System.Object sender, System.EventArgs e)
        {
        ...
        private void InsertP_Click(System.Object sender, System.EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    else if ((Convert.ToInt32(DGV.Rows[i].Cells[4].Value)) == 31)
                    {
                        CheckBox31.Enabled = false;
                    }
